...
const AccountProfile = ({ user, btnTitle }: AccountProfileProps) => {
  ...
  const handleChangeImage = (e: ChangeEvent<HTMLInputElement>, fieldChange: (value: string) => void) => {
    e.preventDefault();
          ...
          render={({ field }) => (
            <FormItem className="flex items-center gap-4">
              ...
              <FormControl className="flex-1 text-base-semibold text-gray-200">
                <Input type="file" accept="image/*" placeholder="Upload a photo" className="account-form_image-input" onChange={(e) => handleChangeImage(e, field.onChange)} />
              </FormControl>
            </FormItem>
          )}
        />
